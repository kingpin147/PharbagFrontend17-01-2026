    ...
    <div class="row">
        ...
        <div class="col-12 col-md-3 profile order-last order-md-first">
            <ul class=" nav-tabs flex-column" style="align-items: start;">
                ...
                <li><a href="credit-details.php" class="active">Credit Details</a></li>
         ...
         <div class="mb-3 col-12">
                            <div class="row">
                                <div class="col-12 alert-info">
                                    <div>
                                        <h5> Order Id: <small>${data[i].order_id} </small></h5>
                                        <hr>
                                        ...
                                        <div class="mt-3 orders ${data[i].paid_ammount&&data[i].PGresponse !='{"COD":"paid by admin"}'?" ":"d-none"} ">
                                            <a onclick="generateinvoice('${encodeURI(JSON.stringify(data[i].PGresponse))}')">
