...
<div class="container">
        <div class="product-back">
            <a  onclick="history.go(-1)"><i class="fa fa-arrow-left" id="goback"></i></a>
        </div>
    </div>
...
var x=await fetch(`https://pharmabag.in:3000/seller/send/message/for/ticket/<?php echo $_GET["id"];?>`,{
