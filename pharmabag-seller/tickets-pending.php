                            ...
                            <div class="col-xxl-6 col-lg-6 col-md-5 col-6">
                                <div class="">
                                    ...
                                    <select class="form-control" name="reason">
                                        ...
                                        <option value="Seller:payments">Payment</option>
                                        <option value="Seller:order">Orders</option>
                                        <option value="Seller:delivery">Delivery</option>
                                        <option value="Seller:other">Other Reasons</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xxl-6 col-lg-6 col-md-5 col-6">
...
var x=await fetch(`https://pharmabag.in:3000/seller/my/tickets`,{
   ...
   html+=` <div class="col-12 alert-info mt-4">
                                            <div>
                                                ...
                                                <p>Status :  ${
                                                    ...
                                                    data[i].status==1
                                                    ?'<span class="badge bg-success"> Solved</span>':'<span class="badge bg-warning" style="background:red;">Rejected</span>'
                                                ...
                                                <div class="mt-3 orders" style="display:${data[i].status==1?'none':'initial'};">
...
var x=await fetch(`https://pharmabag.in:3000/seller/create/ticket`,{
...
if(x.status==200){
    ...
    alert("Cannot create ticket at this momment,make sure you filled all the fields.")
}
