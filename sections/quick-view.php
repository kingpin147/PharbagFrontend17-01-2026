...
-->
                        ...
                        <div class="d-flex">
                            <ul>
                                <li><b>Manufactuer: </b> USV PVT Limited</li>
                                <li><b>Category: </b> Tablets</li>
                                <li><b>Stock: </b> 200 In Stock</li>
                                <li><b>Chemical Composition: </b> Glimepiride 3 MG</li>

                            </ul>
                            <ul>
                                <li><b>Expiry:: </b> Dec 31, 2022</li>
                                <li><b>Min qty: </b> 100</li>
                                <li><b>Delivery: </b> in 7 days</li>
                        ...
                        <div class="view-add-group">
                            ...
                            <div class="input-group p-price">
                                <h4 class="view-price">
                                    <span>₹24.00 <br> <small> ₹28.00 </small></span>
                                </h4>
