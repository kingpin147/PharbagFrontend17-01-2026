...
<div class="" style="justify-content: flex-end">
                    <div class="input-group">
                        ...
                        <input type="text" id="gfg" placeholder="type to search " class="form-control">
                    </div>
                </div>
...
for (var i=data.length-1;  i  >=0;  i--) { 
    var tr=document.createElement("tr")
     tr.innerHTML=`
        ...
        <input type="hidden" name="id" value="${data[i].seller_id}">
        <input type="hidden" name="details" value="${encodeURI(JSON.stringify(data[i]))}">
        <button type="submit" class="btn btn-primary btn-sm">Manage Settlements</button>
    </form> </td>
                            <td> <a href="settelementhistory.php?id=${data[i].seller_id}" class="btn btn-primary btn-sm"> View history </a> </td>
...
getorders()
        ...
        <div class="container">
            ...
            <ul class="pagination" style="justify-content: flex-end">
              <li class="page-item page-prev"><a href="#" class="page-link" onclick="getorders()"> Load more </a></li>
