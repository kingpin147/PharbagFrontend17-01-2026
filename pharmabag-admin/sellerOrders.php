...
var res = await fetch("https://pharmabag.in:3000/admin/auth/orders/seller/<?php echo $_GET['seller_id'];?>",{"headers" : {"content-type":"application/json","auth-token":"<?php echo $_SESSION["token"];?>"} });
if(res.status==401){
...
${data[i].order_status=="divided"?`      
    ...
    html+=`
     ...
     <tr>
                                    ...
                                    <td> <a href="#" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#upload-invoice${i}">Upload</a> </td>
