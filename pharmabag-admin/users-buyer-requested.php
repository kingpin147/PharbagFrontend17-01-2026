...
var res = await fetch("https://pharmabag.in:3000/admin/all/requested/buyer/"+offset,{"headers" : {"content-type":"application/json","Authorization":"<?php echo $_SESSION['token'];?>"} });
if(res.status!=200){
...
for (var i=data.length-1;  i  >=0;  i--) { 
    var tr=document.createElement("tr")
     tr.innerHTML=`      <td>${data[i].buyer_number_id }</td>
        ...
        <li><a class="dropdown-item" onclick="changestatus('${data[i].buyer_id}','0')">Rejector keep in under-review</a></li>
