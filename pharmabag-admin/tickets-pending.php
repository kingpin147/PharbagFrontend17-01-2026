            ...
            <div class="" id="raise-tickets">
                <div class="" style="justify-content: flex-end">
                    <div class="input-group">
                        ...
                        <input type="text" id="gfg" placeholder="search tickets" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container border" style="border-radius: 5px">
            ...
            <div class="table-responsive p-3">
                <table class="table table-borderless" id="tickets">
                    ...
                    <tbody class="align-items-center" id="ticket-summary">
                      
                    </tbody>
<script>
    var offset=0
    const getorders =async(e)=>{
var res = await fetch("https://pharmabag.in:3000/admin/all/ticket/"+offset,{"headers" : {"content-type":"application/json","Authorization":"<?php echo $_SESSION['token'];?>"} });
if(res.status!=200){
...
for (var i=data.length-1;  i  >=0;  i--) { 
    var tr=document.createElement("tr")
     tr.innerHTML=`
                            ...
                            <td style="white-space: break-spaces;"> ${data[i].message} </td>
                            ...
                            <td> <a href="ticket-details.php?id=${data[i]._id}&data=${data[i].message}&time=${data[i].createdAt}" class="btn btn-primary btn-sm"> View </a> </td>
