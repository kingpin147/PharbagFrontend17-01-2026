...
<div id="chatbox" style="height: 58vh;overflow: scroll;">
        ...
        <div class="input-group mt-4" id="reply">
            <input id="chat_input" type="text" class="form-control col-3" placeholder="Your Reply" name="email" required>
            <button class="input-group-text btn-primary" id="replay" onclick="sendmessage()">Reply</button>
            <button class="input-text" style="background: #8bc73a;" id="closechat" onclick="closed()">refresh</button>
            <button class="input-text" style="background: #73ff00;" id="closechat" onclick="solved()">Solved!</button>
        </div>
...
var x=await fetch(`https://pharmabag.in:3000/admin/solve/ticket/<?php echo $_GET["id"];?>`,{
...
if(x.status==200){
    getmessage()
    ci.value='';
    location.href="tickets-pending.php"
