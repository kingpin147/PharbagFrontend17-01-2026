...
var res = await fetch("https://pharmabag.in:3000/admin/seller/payments/history/<?php echo $_GET['id'];?>",{"headers" : {"content-type":"application/json","Authorization":"<?php echo $_SESSION['token'];?>"} });
if(res.status!=200){
