            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    ...
                    <form class="ms-auto position-relative">
                        ...
                        <input class="form-control ps-5" type="text" placeholder="search" id="gfg">
                    </form>
...
var x=await fetch(`https://pharmabag.in:3000/admin/get/all/referel`,{
   ...
   html+=`   <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3 cursor-pointer">
                                        <div class="">
                                            <p class="mb-0">${data[i].user_name}</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        ...
                                        <a href="referral-details.php?code=${data[i].code}" class="text-primary" title="View"><i class="bi bi-eye-fill"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form onsubmit="event.preventDefault()" id="ticketform">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <button type="button" class="btn btn-primary mt-3" onclick="raiseTicket()">Submit</button>
                    </form>
                </div>
            </div>
        </div>
...
var x=await fetch(`https://pharmabag.in:3000/admin/create/referel/code`,{
